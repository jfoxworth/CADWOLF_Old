...
echo('<div id="Work_Block">');
	...
	echo('<div class="Value_Wrapper">');
		echo('<div class="Value_Inner">');
			echo('<div class="banner_main_title">Company Culture</div>');
			echo('<div class="bold_block">This is a long game</div>');
			echo('<div class="Value_Text">');
				echo('<p>We are not designing the next generation of engineering software. We are attempting to create a platform that redefines the way companies think of engineering. This takes time. The ');
				...
				echo('<p>In this spirit each phase of the platform will be something that users love before we develop the next phase. We will develop worksheets that users love prior to developing ');
				echo('a part numbering system and a signoff system, and we will ensure that users love those things before we move on to the CAD modeling system.</p>');
				echo('<p>We hope that 10 years from now an engineering student will be told about how things were done prior to CADWOLF and then giggle a little at how low tech things were back then.</p>');
			echo('</div>');
			...
			echo('</div>');
			echo('<div class="bold_block">Hire good people</div>');
			echo('<div class="Value_Text">');
				echo('<p>There are engineers and programmers that work to live, and there are engineers and programmers that work to solve ');
				echo('problems for the same reasons that people climb mountains - because they are there. These are the people we seek to hire. Changing the world of engineering is the goal of the company, ');
				echo('but the individual people should work to solve problems because they consider the very existence of those problems as a challenge to their manhood (or womanhood).</p>');
				echo('<p>Engineers and programmers should look to learn new languanges and new platforms. Move fast, try new things, ask questions, answer questions. Engineers should never be afraid to ');
				echo('bring forward an idea or a solution.</p>');
			echo('</div>');
		echo('</div>');
	echo('</div>');
echo('</div>');
