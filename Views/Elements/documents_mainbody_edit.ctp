...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
	echo('<div id="plot_spec" class="top_spec">');
		echo('<div id="plot_mainselectwrapper">');
			...
			echo('<div class="simplewrap"><div class="plot_mainselector" id="textselect"></div><div class="mainselecttext">Text</div></div>');
...
//						echo('<div class="plot_optionline"><div class="plot_label85">Categories</div><select class="plot_xcategoriesselect" id="plot_xcategories"><option></option></select><input type="text" class="plot_xcategoriesinput"></div>');
	//						echo('<div class="plot_optionline"><div class="plot_label85">Categories</div><div class="plot_tabledata">&nbsp</div><div class="plot_selectwrap"><select class="plot_xcategoriesselect" id="plot_xcategories"><option></option></select><input type="text" class="plot_xcategoriesinput"></div></div>');
		...
		echo('<div class="plot_optionblock" id="plot_formatblock">');
			echo('<div id="plot_optionsright">');
				echo('<div  class="plot_datablock" id="plot_formatdata" >');
					echo('<div class="plot_subtabline">');
						echo('<div id="plot_formatTitle" class="xplot_subtab xplot_subtab_active">Title</div>');
						echo('<div id="plot_formatFormat" class="xplot_subtab">Format</div>');
						echo('<div id="plot_formatLegend" class="xplot_subtab">Legend</div>');
					echo('</div>');
					echo('<div id="plot_titleSection" class="plot_subclass">');
					...
					echo('</div>');
					echo('<div id="plot_formatSection" class="plot_subclass">');
					...
					echo('</div>');
					echo('<div id="plot_legendSection" class="plot_subclass">');
		...
		echo('<div class="plot_optionblock" id="plot_textblock">');
			echo('<div class="top_third" id="plot_plottextsection">');
				echo('<div class="plot_suboptions" id="plot_chartoptiontextsection" >');
				echo('<div class="plot_chartoptionstitle">Text on Plot</div>');
					echo('<div id="plot_addlinewrapper"><div id="plot_addplottext">Add Text</div></div>');
					echo('<div id="plot_textnames">');	
					echo('</div>');
                    echo('<div id="plot_texttemplate" class="plot_textnameline"><div class="plot_textname">Plot Text 1</div><div class="plot_deletetext">&nbsp</div></div>');
					echo('<div id="plot_textoptions">');	
						echo('<div class="plot_textline"><div class="plot_texttext">Text</div><input id="plot_textText" class="plot_texttextbox" value=""></div>');
						echo('<div class="plot_textline"><div class="plot_texttext">X Loc</div><input id="plot_textXLoc" class="plot_texttextbox" value=""></div>');
						echo('<div class="plot_textline"><div class="plot_texttext">Y Loc</div><input id="plot_textYLoc" class="plot_texttextbox" value=""></div>');
						echo('<div class="plot_textline"><div class="plot_texttext">Color</div><input id="plot_textColor" class="plot_texttextbox" value=""></div>');
						echo('<div class="plot_textline"><div class="plot_texttext">Angle</div><input id="plot_textRotAng" class="plot_texttextbox" value=""></div>');
						echo('<div class="plot_textline"><div class="plot_texttext">Size</div><input id="plot_textSize" class="plot_texttextbox" value=""></div>');
					echo('</div>');
				echo('</div>');
			echo('</div>');
		echo('</div>');
