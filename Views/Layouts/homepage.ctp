...
<head>
	...
	<?php
		...
		if ($UserData=="The Wolf") { echo $this->Html->css('cadwolf.homepage2'); }else { echo $this->Html->css('cadwolf.homepage'); }
...
<?php 	echo $this->element('analyticstracking'); 
		...
		}else	{	if ($UserData=="The Wolf") { echo $this->element('homebodytest'); }else { echo $this->element('homebody'); } }
