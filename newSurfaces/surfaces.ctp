<?php
/**********************************************************************************************************************************
*	This file is the layout file for the surfaces page. 
***********************************************************************************************************************************/
...
{	
    ...
    ?>
        ...
        <link rel="stylesheet" href="http://www.cadwolf.com/css/cadwolf.surfaceAngular.css" type="text/css">
    ...
    echo $this->element('surface_body'); 
    echo('</html>');
}
?>